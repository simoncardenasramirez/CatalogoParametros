package co.edu.uco.CatalogoParametrosUcoLab.application.features.modulo.actualizarmodulo.usecase.domain.rules;
...
public interface ActualizarModuloNombreIsNotEmptyRule extends DomainRule<ActualizarModuloDomain> {
}
