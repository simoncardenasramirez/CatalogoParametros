...
public final class ActualizarAplicacionDtoInput {
    ...
    public ActualizarAplicacionDtoInput() {
        this(TextHelper.EMPTY, UUIDHelper.getDefault(), false, null, null);
    }

    public ActualizarAplicacionDtoInput(final String nombre, final UUID idOrganizacion, final boolean activa,
    ...
    public static ActualizarAplicacionDtoInput create(final String nombre, final UUID idOrganizacion, final boolean activa,
                                                     final LocalDateTime fechaInicio, final LocalDateTime fechaFinal) {
        return new ActualizarAplicacionDtoInput(nombre, idOrganizacion, activa, fechaInicio, fechaFinal);
    }
