package co.edu.uco.CatalogoParametrosUcoLab.application.features.modulo.crearmodulo;
...
public interface CrearModuloRuleValidator extends RuleValidator<ModuloDomain> {
}
