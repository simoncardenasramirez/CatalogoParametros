...
class CrearParametroDomainTest {
    ...
    void debeAsignarIdPorDefectoCuandoElIdEsNulo() {
        var domain = CrearParametroDomain.create(null, "  parametro  ", UUID.randomUUID(), UUID.randomUUID(), true);
    ...
    void debeAsignarIdsPorDefectoCuandoLosIdsAsociadosSonNulos() {
        var domain = CrearParametroDomain.create(UUIDHelper.getDefault(), "parametro", null, null, true);
    ...
    void debeConservarLosValoresCuandoSeCreaConDatosReales() {
        ...
        var domain = CrearParametroDomain.create(id, "parametro", idFuncionalidad, idTipoParametro, false);
