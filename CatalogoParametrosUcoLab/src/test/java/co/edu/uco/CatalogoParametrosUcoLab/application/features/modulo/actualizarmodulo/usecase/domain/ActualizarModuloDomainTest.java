...
class ActualizarModuloDomainTest {
    ...
    void debeAsignarElUuidPorDefectoCuandoElIdEsNulo() {
        var domain = ActualizarModuloDomain.create(null, "modulo", UUID.randomUUID(), true, null, null);
    ...
    void debeAsignarElUuidPorDefectoCuandoElIdAplicacionEsNulo() {
        var domain = ActualizarModuloDomain.create(UUID.randomUUID(), "modulo", null, true, null, null);
